...
/**
 * A base Fragment to be used with a concrete implementation of [BaseViewModel].
 */
...
abstract class BaseFragment<VDB : ViewDataBinding, VM : BaseViewModel>(
  @LayoutRes private val layoutId: Int
    ...
    /**
     * The content [View] of the current [BaseFragment].
     * Might be null if the current [BaseFragment] is not initialized yet.
     */
    var rootView: View? = null
        private set

    /**
     * Indicates whether the current [BaseFragment]'s content view is initialized or not.
     */
    ...
    final override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (!wasViewCreated && savedInstanceState != null) {
    ...
    // region CanHandleBackPressEvents

    @CallSuper
    override fun onBackPressed(): Boolean {
        val isConsumedByViewModel: Boolean = viewModel?.onBackPressed() ?: false
        val isConsumedByChild: Boolean = childFragmentManager.fragments.handleBackPressEvent()

        return (isConsumedByChild || isConsumedByViewModel)
    }
     ...
     *
     * @param savedInstanceState state bundle brought from the [Fragment.onViewCreated]
     */
